<div class="about-container">
	...
	<div class="content">
		...
		<div class="text-about">
			<div class="full-text">
				<%= i18n.__("IWO! is the result of many developers and designers putting a bunch of APIs together to make the experience of watching IWO movies as simple as possible.") %><br/>
